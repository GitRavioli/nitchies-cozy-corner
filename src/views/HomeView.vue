  ...
  <div class="min-h-screen bg-[#FDDFB7] flex flex-col items-center">
    ...
    <section class="w-full max-w-screen-xl p-4 sm:p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div
        ...
        <div
          class="bg-[#C9AD8C] mt-5 p-4 sm:p-6 rounded-xl shadow-lg transition duration-300 ease-in-out hover:shadow-2xl hover:scale-105 mb-6">
          <h3 class="text-lg font-pixel text-white mb-4">The Long Dark</h3>
          <hr
            class="mb-5 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:bg-[#5E5242]" />
          <p class="text-sm font-pixel-proper text-white">The Long Dark is a survival game set in a cold,
            post-apocalyptic wilderness. Its focus on realistic survival mechanics like managing hunger, fatigue, and
            cold, creates a tense, immersive experience. The game's minimalist, yet beautiful art style enhances the
            feeling of isolation. With no zombies or monsters, the primary threats are the environment and wildlife.
            It’s a slow-paced, thoughtful survival challenge that rewards careful planning and patience.</p>
    ...
    <footer class="w-full py-6 text-center sm:py-8 lg:py-10 relative">
      <p class="font-pixel text-[#5E5242] text-sm sm:text-base lg:text-md">&copy; 2024 Cozy Cabin. All rights reserved.
      </p>
